...
@app.get("/activities/id/{activity_id}", response_model=schemas.Activity)
def read_activity(activity_id: int, db: Session = Depends(get_db)):
    activity = crud.get_activity(db, activity_id)
    return activity

# Get specific activity by name
@app.get("/activities/name/{activity_name}", response_model=schemas.Activity)
...
@app.post("/dateactivity/", response_model=schemas.DateActivity)
